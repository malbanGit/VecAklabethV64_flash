...
{
 last_horizontal1 = Vec_Joy_1_X;
 last_vertical1 = Vec_Joy_1_Y;
	Joy_Digital();
}
...
static inline int joystick_1_leftChange()
{
	return (joystick_1_x() < 0)&& (last_horizontal1 >= 0);
}

static inline int joystick_1_rightChange()
{
	return (joystick_1_x() > 0)&& (last_horizontal1 <= 0);
}

static inline int joystick_1_downChange()
{
	return (joystick_1_y() < 0) && (last_vertical1 >= 0);
}

static inline int joystick_1_upChange()
{
    	return (joystick_1_y() > 0) && (last_vertical1 <= 0);
}
