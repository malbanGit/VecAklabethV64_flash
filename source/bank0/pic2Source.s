...
; macro call ->                     WAIT3    
 .globl here95
here95:                    brn      here95                            ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here99
here99:                    brn      here99                            ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here104
here104:                    brn      here104                            ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here108
here108:                    brn      here108                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here113
here113:                    brn      here113                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here117
here117:                    brn      here117                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here122
here122:                    brn      here122                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here126
here126:                    brn      here126                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here131
here131:                    brn      here131                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here135
here135:                    brn      here135                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here140
here140:                    brn      here140                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here144
here144:                    brn      here144                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here224
here224:                    brn      here224                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here229
here229:                    brn      here229                             ; wait 3 cycles 
...
; macro call ->                     WAIT3    
 .globl here233
here233:                    brn      here233                             ; wait 3 cycles 
...
; macro call ->                     ADD_NOPS_NOU                          ; reduced by ldu ,u - 5 cycles 
 ...
 .globl SMVB_lastDraw_rts_puls
SMVB_lastDraw_rts_puls:
                    puls     u

 .globl SMVB_lastDraw_rts
...
;                    ldd      #0 
 ...
 .globl _SMVB_sceneData
_SMVB_sceneData:
 .word _ScenList_0 ; list of all single vectorlists in this
 .word _ScenList_1
 .word _ScenList_2
 .word _ScenList_3
 .word _ScenList_4
...
_ScenList_1:
	...
	.word SMVB_continue_double
	.byte  0x00, 0x01,  0x21
	.word SMVB_startMove_newY_eq_oldX_single ; y was  0x42, now 0
	.byte  0x49, 0x01,  0x0E
	.word SMVB_startDraw_single
	.byte  0x42, 0x01,  0x00
	.word SMVB_continue_single
...
_ScenList_2:
	...
	.byte  0x6F/2, 0x01, -0x65/2
	.word SMVB_startMove_octo
	.byte  0x6F/2+1, 0x01, -0x65/2-1
	.word SMVB_continue_octo
	.byte  0x6F/2, 0x01, -0x65/2
	.word SMVB_continue_octo
	.byte  0x6F/2+1, 0x01, -0x65/2-1
	...
	.byte  0x4C/2, 0x01, -0x71/2
	.word SMVB_startDraw_double
	.byte  0x4C/2, 0x01, -0x71/2-1
	.word SMVB_continue_double
...
_ScenList_4:
	...
	.byte  0x5B/2, 0x01, -0x6F/2
	.word SMVB_startDraw_tripple
	.byte  0x5B/2+1, 0x01, -0x6F/2-1
	.word SMVB_startDraw_tripple
	...
	.word SMVB_continue_double
	.byte -0x0D, 0x01, -0x5D
	.word SMVB_continue_yStays_single; y is -0x0D
	.byte  0x67, 0x01,  0x00
	.word SMVB_continue_quadro
	.byte -0x2C, 0x01, -0x78
	.word SMVB_continue_tripple
	...
	.byte  0x49/2, 0x01, -0x6F/2
	.word SMVB_continue_tripple
	.byte  0x49/2+1, 0x01, -0x6F/2-1
	.word SMVB_continue_tripple
